...
public class MasterTester {
	...
	public static void main(String[] args) throws SQLException {
		...
		String jdbcURL = "jdbc:derby:testdb13;create=true";
			...
			while(true){
				...
				switch(c){
					...
					switch(ad){
						case 1:
						//add
						System.out.println("one row successfully added to Admin table"); 
						break;
						case 2:
						//update
						System.out.println("one row successfully updated to Admin table"); 
						break;
						case 3:
						//Delete
						System.out.println("one row successfully deleted from Admin table"); 
						break;
						case 4:
						//Display
